...
Nous espérons vous voir très bientôt en jeu. Construisez, explorez, combattez le Maelstrom !
    `,
    categories: ['ANNONCE', 'LANCEMENT'],
    categoryColors: ['#7c3aed', '#3b82f6'],
    author: 'AdminReborn',
    date: '18/03/2026',
    coverColor: '#1a0a2e',
  },
...
- **Crux Prime** : le champ de bataille ultime, réservé aux joueurs de niveau 30+
- **Nouvelles missions** : 12 missions principales et 8 missions secondaires
- **Boss inédit** : affrontez le Général Maelstrom avec votre équipe
- **Loot exclusif** : armures et armes uniques disponibles uniquement dans ce monde
- **Corrections de bugs** : plus de 30 corrections de stabilité

### Comment y accéder ?

Rendez-vous à Nexus Tower et parlez au Portail de Crux. Vous devez être niveau 30 minimum.

Bonne aventure !
    `,
    categories: ['MISE-À-JOUR', 'MONDE'],
    categoryColors: ['#22c55e', '#7c3aed'],
    author: 'AdminReborn',
    date: '11/03/2026',
    coverColor: '#1a0a14',
  },
...
Nous avons mis à jour nos règles. Voici les points essentiels.
